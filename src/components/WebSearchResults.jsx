...
export default function WebSearchResults({results}) {
  return (
    <div className='w-full mx-auto px-3 pb-50 sm:pb-24 sm:pl-[5%] md:pl-[14%] lg:pl-52'>
        ...
        {results.items?.map((result)=>(
            <div className='mb-8 max-w-xl' key={result.title}>
                ...
                <p className='text-xl truncate font-medium text-gray-600'>{Parser(result.htmlSnippet)}</p>
            </div>
        ))}
        <PaginationBtns />
    </div>
